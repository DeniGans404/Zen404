...
#Gak Usag Compas Hekel+62
#MIKIR ANJING GUA BUAT CAPE_-
                YOU KNOW ME
#02/02/2002
...
sleep 1
echo -b $green"[#]> Mr.zen YOU KNOW ME" |lolcat
...
echo -e "######################################" | lolcat
echo -e "#WAIT ....... KOPI DLU SLUR:V#" | lolcat
echo -e "######################################" | lolcat
...
00) echo "PEMBUAT By: MR.ZEN" | lolcat
echo "Mr.zen #YOU KNOW ME" | lolcat
echo "INDONESIAN DARK NET" | lolcat
echo "SEMUA TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY TOOLS GUA" | lolcat
figlet MR.ZEN404 | lolcat
exit
;;
